...
function Footer() {
  return (
    <>
    <div className=" relative p-[2%] ml-[2%] mr-[2%] mb-[-8%] bg-[#000] rounded-[30px] h-[180px] flex flex-row justify-evenly items-center z-[99]">

    <h1 className="text-[40px] font-['PlayfairDisplay'] w-[500px] text-[#fff]">STAY UPTO DATE ABOUT OUR LATEST OFFERS</h1>
 ...
 <div className="w-[100%] h-[50vh] bg-[#f2eff0]
  absolute z-50 ">
 
 <div className='ml-[5%] mt-[8%] mr-[5%] flex flex-row justify-between items-center gap-[20px]'>
 <div className='w-[200px] flex flex-col justify-center items-start gap-[10px]'>
             <h1 className="font-['PlayfairDisplay'] font-[5rem] font-bold">SHOP.CO</h1>
             <p className='font-regular font-[16px] font-["Satoshi"] '>We have clothers that suits yours style and which you&apos;re product to wear. 
             </p>
